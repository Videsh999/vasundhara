          ...
          {displayEvents.map((item, idx) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-[#EFE9DA]">
                ...
                />
                <div className="absolute top-4 left-4 px-3 py-1 bg-[#FDFBF7]/90 backdrop-blur-md rounded-full text-[9px] uppercase tracking-[0.2em] text-[#B09262] font-medium border border-[#B09262]/25">
                  {item.eventType}
                </div>
              </div>
