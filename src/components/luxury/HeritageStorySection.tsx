...
const HERITAGE_CUBE_ITEMS: CarouselItem[] = [
  {
    id: 1,
    type: "image",
    srcUrl: "/brand/vasundhara-royal-bridal-trinity.jpg",
    alt: "The Royal Bridal Trinity - Three Royal Brides in Nizam Heirloom Suites",
  ...
  },
  {
    id: 2,
    type: "image",
    srcUrl: "/brand/vasundhara-emerald-solitaire-bib-suite.jpg",
    alt: "Colombian Emerald & D-Flawless Solitaire Mesh Bib Suite",
    title: "HIGH JEWELLERY MAJESTY",
    subtitle: "Rare Solitaire Meshes & Colombian Emeralds",
  },
  {
    id: 3,
    type: "image",
    srcUrl: "/brand/vasundhara-nizam-rajmata-polki-portrait.jpg",
    alt: "Antique Nakshi & Syndicate Polki Nizam Rajmata Suite in Pink Silk",
    title: "NIZAM POLKI PROVENANCE",
    subtitle: "22K Pure Nakshi Carving & Uncut Polki",
  },
  {
    id: 4,
    type: "image",
    srcUrl: "/brand/vasundhara-crimson-bridal-emerald.jpg",
    alt: "Crimson Bridal Lehenga with Multi-Tiered Emerald & Polki Choker",
