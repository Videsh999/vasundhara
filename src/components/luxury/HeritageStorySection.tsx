...
const HERITAGE_CUBE_ITEMS: CarouselItem[] = [
  {
    id: 1,
    type: "image",
    srcUrl: "/brand/vasundhara-royal-bride-portrait.jpg",
    alt: "Vasundhara Royal Bridal Heritage Portrait in Purple Silk & Temple Gold",
  ...
  },
  {
    id: 2,
    type: "image",
    srcUrl: "/brand/vasundhara-nizam-emerald-polki-suite.jpg",
    alt: "Regal Nizam Emerald & Polki Choker Suite with Drops",
  ...
  },
  {
    id: 4,
    type: "image",
    srcUrl: "/brand/vasundhara-temple-peacock-necklace.jpg",
    alt: "Sacred Temple Peacock & Basra Pearl Long Necklace",
